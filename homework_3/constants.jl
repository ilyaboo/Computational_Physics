...
const T0 = 86164   # length of siderial day 
const a = 1.0   # ratio of satellite's period and siderial day length
const Ts = a * T0
const Tm = 27.25 * Ts   # period for the Moon
const Rs = (GMe * Ts^2 / 4 / π^2)^(1/3)   # radius of the orbit of the satellite
const Rm = 384400.0 * 10^3   # distance from moon to Earth's center